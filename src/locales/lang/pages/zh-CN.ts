export default {
  ...
  'system.menu.add': '新增',
  'system.menu.add-child': '新增',
  'system.menu.role': '权限',
  'system.menu.edit': '编辑',
  'system.menu.delete': '删除',
  'system.menu.delete-confirm': '确定删除吗？',
  'system.menu.delete-success': '删除成功',
  'system.menu.delete-id-required': 'id 不能为空',
  'system.menu.delete-has-children': '请先删除子菜单',
  'system.menu.table-title': '菜单名称',
  'system.menu.table-parent-title': '上级菜单',
  'system.menu.table-keep-alive': '菜单缓存',
  'system.menu.table-path': '菜单路由',
  'system.menu.table-icon': '图标',
  'system.menu.table-sort': '排序',
  'system.menu.table-locale': '国际化',
  'system.menu.table-component': '组件路径',
  'system.menu.table-action': '操作',
  'system.menu.model-title-add': '新增菜单',
  'system.menu.model-title-edit': '编辑菜单',
  'system.menu.placeholder-title': '请输入菜单名称',
  'system.menu.placeholder-parent-title': '请选择上级菜单',
