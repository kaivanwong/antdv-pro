export default {
  ...
  'system.menu.delete-success': 'Successfully deleted',
  'system.menu.delete-id-required': 'id cannot be empty',
  'system.menu.delete-has-children': 'Please delete the child menu first',
  'system.menu.table-title': 'Name',
  'system.menu.table-parent-title': 'Parent menu',
  'system.menu.table-keep-alive': 'Keep Alive',
  'system.menu.table-path': 'Path',
  'system.menu.table-icon': 'Icon',
  'system.menu.table-sort': 'Sort',
  'system.menu.table-locale': 'Locale',
  'system.menu.table-component': 'Component',
  'system.menu.table-action': 'Action',
  'system.menu.model-title-add': 'Add menu',
  'system.menu.model-title-edit': 'Edit menu',
  'system.menu.placeholder-title': 'Please enter the menu name',
